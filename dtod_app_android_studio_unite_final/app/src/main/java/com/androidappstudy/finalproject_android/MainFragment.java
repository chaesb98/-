...
public class MainFragment extends Fragment implements OnMapReadyCallback  {
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(new LatLng(37.5030698,126.8789856), 14);

        googleMap.animateCamera(cameraUpdate);

        LatLng dtod = new LatLng(37.5030698,126.8789856);
        googleMap.addMarker(new MarkerOptions().position(dtod).title("Location : 하이미디어구로학원"));
    }
}
